\documentclass[final]{siamonline1116}
...
\begin{itemize}
\item \texttt{siamonline1116.cls} (required): Main SIAM online-only \LaTeX\ class file.
...
\end{itemize}
To use these files, put \texttt{siamonline1116.cls} and
...
\documentclass[supplement]{siamonline1116}
\input{ex_shared}
...
\begin{itemize}
\item Change in file names: \texttt{siamltexmm.cls} is replaced by
  \texttt{siamonline1116.cls}, and the \texttt{siam.bst} bibliography style
